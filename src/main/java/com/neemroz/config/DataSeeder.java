    ...
    CommandLineRunner seedData(ProductRepository productRepository) {
        return args -> {
            ...
            List<Product> products = Arrays.asList(
                    ...
                    // ─────────────────────────────────────────
                    // BEDSHEETS — images new-21 to new-33
                    // ─────────────────────────────────────────
                    Product.builder()
                            ...
                            .category("bedsheet")
                            .imageUrl(BASE + "new-21.jpg")
                            .images(Arrays.asList(BASE + "new-21.jpg", BASE + "new-22.jpg", BASE + "new-23.jpg"))
                    ...
                    Product.builder()
                            ...
                            .price(BigDecimal.valueOf(3500.00)).oldPrice(BigDecimal.valueOf(4500.00))
                            .category("bedsheet")
                            .imageUrl(BASE + "new-24.jpg")
                            .images(Arrays.asList(BASE + "new-24.jpg", BASE + "new-25.jpg"))
                    ...
                    Product.builder()
                            ...
                            .price(BigDecimal.valueOf(3500.00)).oldPrice(BigDecimal.valueOf(4500.00))
                            .category("bedsheet")
                            .imageUrl(BASE + "new-26.jpg")
                            .images(Arrays.asList(BASE + "new-26.jpg", BASE + "new-27.jpg"))
                    ...
                    Product.builder()
                            ...
                            .price(BigDecimal.valueOf(3500.00)).oldPrice(BigDecimal.valueOf(4500.00))
                            .category("bedsheet")
                            .imageUrl(BASE + "new-28.jpg")
                            .images(Arrays.asList(BASE + "new-28.jpg", BASE + "new-29.jpg"))
                    ...
                    Product.builder()
                            ...
                            .price(BigDecimal.valueOf(3500.00)).oldPrice(BigDecimal.valueOf(4500.00))
                            .category("bedsheet")
                            .imageUrl(BASE + "new-30.jpg")
                            .images(Arrays.asList(BASE + "new-30.jpg", BASE + "new-31.jpg"))
                    ...
                    Product.builder()
                            ...
                            .price(BigDecimal.valueOf(3500.00)).oldPrice(BigDecimal.valueOf(4500.00))
                            .category("bedsheet")
                            .imageUrl(BASE + "new-32.jpg")
                            .images(Arrays.asList(BASE + "new-32.jpg", BASE + "new-33.jpg"))
                            .colors(Arrays.asList("#800000"))
                            .sizes(Arrays.asList("Double", "King"))
                            .stock(10).badge("NEW").rating(4.7).reviewCount(29).isActive(true).build(),

                    // ─────────────────────────────────────────
                    // KIDS WEAR — images new-1 to new-20
                    // ─────────────────────────────────────────
                    Product.builder()
                            .name("Black Peplum Dhoti Salwar Set")
                            .description("Elegant black peplum kurta with dhoti salwar and dupatta. Features beautiful gold trim borders. Perfect for festivals, weddings and special occasions.")
                            .price(BigDecimal.valueOf(1299.00)).oldPrice(BigDecimal.valueOf(1899.00))
                            .category("kids")
                            .imageUrl(BASE + "new-1.jpg")
                            .images(Arrays.asList(BASE + "new-1.jpg", BASE + "new-2.jpg", BASE + "new-3.jpg"))
                    ...
                    Product.builder()
                            ...
                            .price(BigDecimal.valueOf(1299.00)).oldPrice(BigDecimal.valueOf(1899.00))
                            .category("kids")
                            .imageUrl(BASE + "new-4.jpg")
                            .images(Arrays.asList(BASE + "new-4.jpg", BASE + "new-5.jpg", BASE + "new-6.jpg"))
                            .colors(Arrays.asList("#000000"))
                            .sizes(Arrays.asList("S", "M", "L", "XL"))
                    ...
                    Product.builder()
                            ...
                            .price(BigDecimal.valueOf(1299.00)).oldPrice(BigDecimal.valueOf(1899.00))
                            .category("kids")
                            .imageUrl(BASE + "new-7.jpg")
                            .images(Arrays.asList(BASE + "new-7.jpg", BASE + "new-8.jpg", BASE + "new-9.jpg"))
                    ...
                    Product.builder()
                            ...
                            .price(BigDecimal.valueOf(1299.00)).oldPrice(BigDecimal.valueOf(1899.00))
                            .category("kids")
                            .imageUrl(BASE + "new-10.jpg")
                            .images(Arrays.asList(BASE + "new-10.jpg", BASE + "new-11.jpg", BASE + "new-12.jpg", BASE + "new-13.jpg"))
                    ...
                    Product.builder()
                            ...
                            .price(BigDecimal.valueOf(1299.00)).oldPrice(BigDecimal.valueOf(1899.00))
                            .category("kids")
                            .imageUrl(BASE + "new-14.jpg")
                            .images(Arrays.asList(BASE + "new-14.jpg"))
                            .colors(Arrays.asList("#CC0000"))
                            .sizes(Arrays.asList("S", "M", "L", "XL"))
                    ...
                    Product.builder()
                            ...
                            .price(BigDecimal.valueOf(1299.00)).oldPrice(BigDecimal.valueOf(1899.00))
                            .category("kids")
                            .imageUrl(BASE + "new-15.jpg")
                            .images(Arrays.asList(BASE + "new-15.jpg", BASE + "new-16.jpg", BASE + "new-17.jpg"))
                    ...
                    Product.builder()
                            ...
                            .description("Elegant maroon booti printed gharara set with gold coin lace trim. Traditional gold print on rich maroon fabric, perfect for weddings, Eid and festive occasions.")
                            .price(BigDecimal.valueOf(1299.00)).oldPrice(BigDecimal.valueOf(1899.00))
                            .category("kids")
                            .imageUrl(BASE + "new-19.jpg")
                            .images(Arrays.asList(BASE + "new-19.jpg", BASE + "new-20.jpg"))
                            .colors(Arrays.asList("#800000"))
                            .sizes(Arrays.asList("S", "M", "L", "XL"))
                    ...
                    Product.builder()
                            ...
                            .category("women")
                            .imageUrl(BASE + "new-18.jpg")
                            .images(Arrays.asList(BASE + "new-18.jpg"))
                            .colors(Arrays.asList("#800000"))
                            .sizes(Arrays.asList("S", "M", "L", "XL"))
